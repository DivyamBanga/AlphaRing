      ...
      <div className="mx-auto max-w-3xl px-4 space-y-8">
        ...
        >
          <button
            ...
            className="flex-1 py-3.5 rounded-xl bg-gradient-to-r from-accent to-cyan-300 text-surface font-semibold text-sm hover:shadow-lg hover:shadow-accent/25 hover:scale-[1.01] transition-all duration-300 btn-shine"
          >
